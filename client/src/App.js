    ...
    return (
        <div className="app">
            ...
            <div className="form-container">
                <input type="text" placeholder="New user namess" value={name} onChange={(e) => setName(e.target.value)} />
                <input type="email" placeholder="New user emails" value={email} onChange={(e) => setEmail(e.target.value)} />
